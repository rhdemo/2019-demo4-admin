...
async function createLeaderboard() {
  let leaderboardStr = await global.dataClient.get(DATAGRID_KEYS.LEADERBOARD);
  ...
  if (leaderboardStr) {
    ...
    global.dataClient.put(DATAGRID_KEYS.LEADERBOARD, JSON.stringify(global.leaderboard));
  }
